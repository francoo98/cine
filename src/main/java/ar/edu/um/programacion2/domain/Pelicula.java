...
public class Pelicula implements Serializable {
	...
	public String toString() {
		return "Pelicula{" + "id=" + getId() + ", nombre='" + getNombre() + "'" + ", descriptcion='" + getDescriptcion()
				+ "'" + ", detalle='" + getDetalle() + "'" + ", duracion=" + getDuracion() + ", genero='" + getGenero()
				+ "'" + ", clasificacion='" + getClasificacion() + "'" + ", estado='" + isEstado() + "'"
